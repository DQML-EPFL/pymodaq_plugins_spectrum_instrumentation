...
EXTENSION_NAME = 'DAQScan_v3_copy'
CLASS_NAME = 'DAQScan_v3_copy'



class DAQScan_v3_copy(QObject, ParameterManager):
    """
        ...
        * "Timeout"
        ...
        if status.command == "Update_Status":
            ...
            if self._multi_scan_running:
                ...
                if self._multi_scan_index < N_SCANS_PER_PLAY:
    ...
    def set_metadata_about_current_scan(self):
        ...
        self.scan_attributes.child('scan_info', 'scan_angle').setValue(self._multi_scan_index + 1)
    ...
    def _start_one_scan(self):
        ...
        self.ui.display_status(
            f'Starting acquisition {self._multi_scan_index + 1}/{N_SCANS_PER_PLAY}')
        logger.info(
            f'Multi-scan: starting scan {self._multi_scan_index + 1}/{N_SCANS_PER_PLAY}')
...
def main():
    ...
    preset_file_name = "Lockin + Piezo + Zaber (MOS and EOS)"
