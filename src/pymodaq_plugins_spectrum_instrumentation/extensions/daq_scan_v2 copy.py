...
EXTENSION_NAME = 'DAQScan_v2'
CLASS_NAME = 'DAQScan_v2'



class DAQScan_v2(QObject, ParameterManager):
    """
...
class DAQScanAcquisition(QObject):
    ...
    def __init__(self, scan_settings: Parameter = None, scanner: Scanner = None,
        ...
        self.angle_list = np.linspace(self.scan_settings.child('polarizer_scan', 'start').value(), self.scan_settings.child('polarizer_scan', 'end').value(), self.scan_settings.child('polarizer_scan', 'steps').value())
...
def main():
    ...
    dashboard, extension, win = load_dashboard_with_preset(preset_file_name, 'DAQScan_v2')
